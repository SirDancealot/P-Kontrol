...
public class CustomProgressBar extends View {
    ...
    public CustomProgressBar(Context context , AttributeSet attrs) {
        ...
        try {
            ...
            progressValue       = a.getInteger(R.styleable.CustomProgressBar_ptip_progressValue, 0);
            progressNumSteps    = a.getInteger(R.styleable.CustomProgressBar_ptip_progressNumSteps, 5);

            // get Attributes Color, or Set the Default.
            colorBorder.setColor(a.getColor(R.styleable.CustomProgressBar_ptip_progress_ColorBorder, Color.BLACK   ));
            colorNonProgress.setColor(a.getColor(R.styleable.CustomProgressBar_ptip_progress_ColorNonProgress, Color.GRAY    ));
            colorProgress.setColor(a.getColor(R.styleable.CustomProgressBar_ptip_progress_ColorProgress, Color.YELLOW  ));
            ...
            progressBarHeight   = a.getInteger(R.styleable.CustomProgressBar_ptip_progressBarHeight,1);
            progressPointRadius = a.getInteger(R.styleable.CustomProgressBar_ptip_progressPointdiagonal, 2);
            progressPointMargin = a.getInteger(R.styleable.CustomProgressBar_ptip_progressPointMargin, 5);
            progressBorderThick = a.getInteger(R.styleable.CustomProgressBar_ptip_progressBorderThickness, 0);
